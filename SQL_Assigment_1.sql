...
--The important difference between the two questions is the sorting by brand_id and list_price categories. The first question sorts by brand_id and shows the highest price for the same brand. The second question lists by list_price and shows if the brand is repeated.
